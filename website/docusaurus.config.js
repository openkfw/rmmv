...
const config = {
  ...
  baseUrl: '/rmmv/', // Should match your repo name

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'openkfw',
  projectName: 'rmmv', // Should match your repo name
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/openkfw/rmmv/tree/main/website/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/openkfw/rmmv/tree/main/website/blog/',
